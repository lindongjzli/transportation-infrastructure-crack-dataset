...
from model_efficientnet import efficientnet_b4 as create_model
...
def main(args):
    ...
    if args.freeze_layers:
        for name, para in model.named_parameters():
            # Freeze all layers except the last conv and FC layer
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="pre-weights/efficientnet_b4-pre.pth",
