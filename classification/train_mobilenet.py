...
from model_mobilenet_v3 import mobilenet_v3_small
...
def main(args):
    ...
    net = mobilenet_v3_small(num_classes=args.num_classes)
    model_weight_path = "pre-weights/mobilenet_v3_small-pre.pth"
    ...
    for epoch in range(epochs):
        ...
        # Validate
        acc = evaluate(model=net, data_loader=val_loader, device=device)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset_root", default="../dataset", help="Images folder"
    )
    parser.add_argument(
