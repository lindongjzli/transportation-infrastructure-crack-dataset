...
from model_mobile_vit import mobile_vit_small as create_model
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="pre-weights/mobilevit_s.pt",
    ...
    parser.add_argument("--model_name", default="mobilevit", help="create model name")
    parser.add_argument(
