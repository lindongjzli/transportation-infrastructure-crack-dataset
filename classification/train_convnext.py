...
from model_convnext import convnext_tiny as create_model
...
def main(args):
    ...
    for epoch in range(epochs):
        # Train
        train_loss, train_acc = train_one_epoch_(
            model=model,
            optimizer=optimizer,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="pre-weights/convnext_tiny_1k_224_ema.pth",
    ...
    parser.add_argument("--model_name", default="convnext", help="create model name")
    parser.add_argument(
