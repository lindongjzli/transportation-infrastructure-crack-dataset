...
launcher = 'none'
load_from = 'work_dir_1_specific/retinanet/epoch_48.pth'
log_level = 'INFO'
...
train_cfg = dict(max_epochs=48, type='EpochBasedTrainLoop', val_interval=4)
...
work_dir = 'work_dir_1_specific/retinanet'
