...
launcher = 'none'
load_from = 'work_dir_1_specific/fcos/epoch_35.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    ...
    optimizer=dict(lr=0.01, type='SGD', weight_decay=0.0001),
...
train_cfg = dict(max_epochs=35, type='EpochBasedTrainLoop', val_interval=5)
...
work_dir = 'work_dir_1_specific/fcos'
